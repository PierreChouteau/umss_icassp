...
for s, mix_dir in enumerate(mixture_dirs):
    ...
    for f0_csv_file in f0_csv_files:
        ...
        if 'CEA' in f0_csv_file: audio_length = 118
        elif 'EJB1' in f0_csv_file: audio_length = 300
        elif 'EJB2' in f0_csv_file: audio_length = 57
        elif 'HCB' in f0_csv_file: audio_length = 36
        elif 'LBM1' in f0_csv_file: audio_length = 300
        elif 'LBM2' in f0_csv_file: audio_length = 271
        elif 'LJT1' in f0_csv_file: audio_length = 300
        elif 'LJT2' in f0_csv_file: audio_length = 205
        elif 'LNG' in f0_csv_file: audio_length = 183
        elif 'RRC' in f0_csv_file: audio_length = 56
        elif 'SSS' in f0_csv_file: audio_length = 118
        elif 'THM' in f0_csv_file: audio_length = 126
        elif 'VBP' in f0_csv_file: audio_length = 69
        elif 'YSM' in f0_csv_file: audio_length = 33
